...
- http://51.250.35.196:3000/hw/store/ - адрес виртуальной машины, на которой развернут контейнер с приложением.
- Реализованы флоу с созданием релиза, внесением фикса к релизу, публикации релиза на виртуальной машине.
- Внесен запрет на пуш изменений в ветку main, только через PR. При открытии PR будут запущены проверки и тесты.
